        ...
        <>
            <section className='min-h-screen bg-base-100'>
                <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
                    <a rel="noopener noreferrer" href="/nyheder/rallyskole" className="block max-w-sm gap-3 mx-auto sm:max-w-full group rounded-lg hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 dark:bg-gray-50">
                        <img src="/assets/images/DASU-logo.png" alt="DASU logo" className="object-contain w-full h-64 rounded-l-lg sm:h-96 lg:col-span-7 p-2" />
                        <div className="p-6 space-y-2 lg:col-span-5">
                            <h3 className="text-2xl font-semibold sm:text-4xl group-hover:underline group-focus:underline">Er du Danmarks næste rallytalent?</h3>
